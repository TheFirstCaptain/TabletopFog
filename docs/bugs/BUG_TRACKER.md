...
| B-011 | Circle Fog Tool Behaves Like A Brush | Resolved | P2 | [B-011.md](./B-011.md) | 2026-07-06 | Relabeled current fixed-size circular tool as Brush, added freehand drag painting, and passed full quality; true drag-to-size Circle is tracked as F-008E. |
| B-012 | Brush Preview And Size Layout Are Hard To Use | Resolved | P3 | [B-012.md](./B-012.md) | 2026-07-06 | Brush hover now previews the footprint before painting, and the diameter value sits below the slider; full quality passed. |
| B-013 | Shown Encounter Button Height Mismatch | Resolved | P3 | [B-013.md](./B-013.md) | 2026-07-31 | Matched Encounter card action sizing so green `Shown to Players`, normal `Show to Players`, and management buttons keep equal rendered height. |
| B-014 | Encounter Gallery Scroll Jumps On Shown Target Changes | Resolved | P3 | [B-014.md](./B-014.md) | 2026-07-31 | Preserved Campaign screen scroll position while shown-target changes re-render Encounter cards. |
| B-015 | Shown Handout Rotation Buttons Misalign Cards | Resolved | P3 | [B-015.md](./B-015.md) | 2026-08-01 | Compact inline left/right 90-degree controls now sit beside the shown Handout clear action; focused Chromium and full quality passed. |
| B-016 | Handout Shown Action Spacing Shifts | Resolved | P3 | [B-016.md](./B-016.md) | 2026-08-01 | Handout card grid content now stays top-aligned so shown and unshown title-to-action spacing remains consistent; focused Chromium and full quality passed. |
