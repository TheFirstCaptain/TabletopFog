...
| F-005D | Navigation Simplification | Proposed | Proposed | [F-005D.md](./F-005D.md) | 2026-06-25 | Remove implementation-focused UI details, standardize breadcrumbs, simplify headers, and make Back actions obvious. |
| F-005E | Campaign Card Presentation | Proposed | Proposed | [F-005E.md](./F-005E.md) | 2026-06-25 | Improve campaign card typography, spacing, icon, description, metadata, focus, and responsive presentation. |
| F-005F | Encounter Gallery Presentation | Proposed | Proposed | [F-005F.md](./F-005F.md) | 2026-06-25 | Make encounter browsing more visual with larger thumbnails, cleaner hierarchy, better status indicators, and less clutter. |
| F-005G | Encounter Workspace Layout | Proposed | Proposed | [F-005G.md](./F-005G.md) | 2026-06-25 | Rework the workspace around map prominence, status clarity, explicit show placement, and a future tool dock. |
| F-005H | Manage Mode | Proposed | Proposed | [F-005H.md](./F-005H.md) | 2026-06-25 | Separate browsing from administration by moving rename, delete, reorder, and upload controls into a dedicated mode. |
