...
| F-010 | Campaign Image Handouts | Proposed | Proposed | [F-010.md](./F-010.md) | 2026-07-31 | Campaign-wide image handout child slices F-010A through F-010G are complete; F-010H through F-010J are proposed handout polish; umbrella remains a planning record. |
...
| F-010H | Handout Gallery Card Polish | Proposed | Proposed | [F-010H.md](./F-010H.md) | 2026-07-31 | Prepare Handout gallery visual parity with Encounter cards: no divider, count text, or card-level shown pill, and matching show/shown button behavior. |
