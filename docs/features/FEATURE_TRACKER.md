...
| F-005 | Static Active Map Display Polish | Complete | Done | [F-005.md](./F-005.md) | 2026-06-24 | Shared canvas rendering, independent player zoom and pan, display recovery, and full automated validation completed; physical-device checks remain documented with F-004. |
