...
| F-007 | Save and Load Campaign State | Complete | Done | [F-007.md](./F-007.md) | 2026-07-04 | Fog persistence, shown-to-players restore, and recovery validation are complete; optional extra persistence status remains deferred as F-007D. |
...
| F-007B | Restore Shown-to-Players State | Complete | Done | [F-007B.md](./F-007B.md) | 2026-07-03 | GM campaign open restores saved shown encounter and persisted fog to Player Display; startup/library browsing remain empty; full quality passed. |
| F-007C | Persistence Validation and Recovery States | Complete | Done | [F-007C.md](./F-007C.md) | 2026-07-04 | Recovery-aware campaign reads, GM-only diagnostics, missing-asset Player Display safety, storage documentation, independent reviews, and full quality validation are complete. |
| F-007D | Persistence Status and Diagnostics | Deferred | Deferred | [F-007D.md](./F-007D.md) | 2026-07-04 | Deferred by user decision; F-007C covers needed recovery diagnostics and no separate persistence status is justified yet. |
| F-008 | Table Quality-of-Life Improvements | Complete | Done | [F-008.md](./F-008.md) | 2026-07-10 | V1 quality-of-life umbrella is complete through F-008A through F-008E; QR, extra reset polish, and further GM map controls remain post-V1 ideas pending table-use need. |
| F-008A | Player URL Sharing | Complete | Done | [F-008A.md](./F-008A.md) | 2026-07-04 | Quiet GM-only current-origin Player Display URL and copy action are complete, with QR and LAN detection deferred. |
| F-008B | Fullscreen Player View | Complete | Done | [F-008B.md](./F-008B.md) | 2026-07-04 | Player-local fullscreen control is complete with quiet unsupported/denied feedback and no shared-state changes. |
| F-008C | Undo Fog Action | Complete | Done | [F-008C.md](./F-008C.md) | 2026-07-04 | Runtime-only fog undo history, GM-only undo route, quiet Undo UI, focused Node/Chromium coverage, reviews, and full quality validation are complete. |
| F-008D | Expanded Fog Shape Tools | Complete | Done | [F-008D.md](./F-008D.md) | 2026-07-06 | Completed fixed-size circular fog operations; B-011 corrects the current UI to Brush, and F-008E tracks a future drag-to-size Circle shape. |
| F-008E | Drag-To-Size Circle Fog Shape | Complete | Done | [F-008E.md](./F-008E.md) | 2026-07-06 | True Circle shape stretches during drag like Rectangle, while fixed-size circular painting remains Brush. |
...
| F-010 | Campaign Image Handouts | Complete | Done | [F-010.md](./F-010.md) | 2026-08-01 | Campaign-wide image handout child slices F-010A through F-010J are complete; umbrella closed as complete. |
...
| F-010E | Handout Rename and Delete | Complete | Done | [F-010E.md](./F-010E.md) | 2026-07-30 | GM-only handout rename/delete is complete with shown-handout management guards, rollback coverage, and full quality validation. |
| F-010F | Encounter Selected Prep Card Polish | Complete | Done | [F-010F.md](./F-010F.md) | 2026-07-31 | Removed the redundant card-level `Selected for Prep` pill while preserving the selected-card highlight, accessibility state, and Player Display isolation. |
| F-010G | Encounter Shown Button Polish | Complete | Done | [F-010G.md](./F-010G.md) | 2026-07-31 | Removed the redundant card-level `Shown to Players` pill while preserving the shown-state action as a green clear button. |
| F-010H | Handout Gallery Card Polish | Complete | Done | [F-010H.md](./F-010H.md) | 2026-08-01 | Removed Handouts tab divider, count text, and card-level shown pill while preserving green shown clear action, rotation controls, rename/delete guards, and full quality validation. |
| F-010I | GM Handout Rotation Preview | Complete | Done | [F-010I.md](./F-010I.md) | 2026-08-01 | GM View shown-handout preview now follows shared quarter-turn rotation with contained card rendering, unshown isolation, reload restoration, and full quality validation. |
| F-010J | Player-Local Handout Rotation Controls | Complete | Done | [F-010J.md](./F-010J.md) | 2026-08-01 | Player Display toolbar controls rotate shown handouts locally in 90-degree increments without changing shared state. |
| F-011 | Campaign Waiting Screen | Proposed | Proposed | [F-011.md](./F-011.md) | 2026-08-01 | Umbrella for campaign-specific Player Display waiting state and optional GM-managed Campaign Image. |
| F-011A | Campaign-Specific Waiting State | Proposed | Proposed | [F-011A.md](./F-011A.md) | 2026-08-01 | Proposed campaign-name Player Display waiting text and shown-target transitions before Campaign Image storage. |
| F-011B | Campaign Image Management | Proposed | Proposed | [F-011B.md](./F-011B.md) | 2026-08-01 | Proposed GM upload, replace, and remove flow for one campaign-level Campaign Image. |
| F-011C | Campaign Waiting Image Display | Proposed | Proposed | [F-011C.md](./F-011C.md) | 2026-08-01 | Proposed Player Display background rendering and live updates for the Campaign Image while the campaign waiting screen is active. |
