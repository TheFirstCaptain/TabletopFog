...
| F-006F | Fog Tool Polish and Validation | Proposed | Proposed | [F-006F.md](./F-006F.md) | 2026-07-02 | Tier 0 planning pass recorded; later implementation/validation pass should add GM-local zoomed map panning, audit fog workflow, responsive edges, keyboard boundary, docs, and F-006 umbrella completion. |
