...
| F-006 | Manual Fog of War | Proposed | Proposed | [F-006.md](./F-006.md) | 2026-07-01 | Umbrella feature split into F-006B through F-006F after completed F-006A setup; V1 uses in-memory ordered hide/reveal operations. |
...
| F-006C | Rectangle Hide Tool | Proposed | Proposed | [F-006C.md](./F-006C.md) | 2026-07-01 | Add GM rectangle hide drawing for the selected encounter, syncing only when shown to players. |
| F-006D | Rectangle Reveal Tool | Proposed | Proposed | [F-006D.md](./F-006D.md) | 2026-07-01 | Add GM rectangle reveal drawing using ordered operation-list semantics. |
| F-006E | Clear Fog | Proposed | Proposed | [F-006E.md](./F-006E.md) | 2026-07-01 | Add explicit confirmed clear-all-fog action for the selected encounter. |
| F-006F | Fog Tool Polish and Validation | Proposed | Proposed | [F-006F.md](./F-006F.md) | 2026-07-01 | Finish UX, responsive behavior, edge cases, docs, and umbrella validation for F-006. |
