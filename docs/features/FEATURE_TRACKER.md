...
| F-007B | Restore Shown-to-Players State | Active | Clarifying | [F-007B.md](./F-007B.md) | 2026-07-03 | Clarified that restore occurs only after the GM opens a campaign, not automatically on server startup. |
