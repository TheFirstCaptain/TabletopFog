...
| F-006A | GM Map Zoom and Grid Calibration | Proposed | Proposed | [F-006A.md](./F-006A.md) | 2026-06-30 | First fog-adjacent workspace tools: GM-local map zoom, adjustable 5 ft grid overlay, and grid lock/unlock before manual fog drawing. |
