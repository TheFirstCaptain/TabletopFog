...
| F-005P | Campaign Encounter Gallery Simplification | Proposed | Proposed | [F-005P.md](./F-005P.md) | 2026-06-30 | Remove embedded Campaign-page workspace and Manage Mode so Campaign focuses on encounter cards, direct Add Encounter, and opening encounters into the workspace page. |
