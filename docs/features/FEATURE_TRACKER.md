...
| F-008 | Table Quality-of-Life Improvements | Proposed | Proposed | [F-008.md](./F-008.md) | 2026-07-06 | Split child features F-008A through F-008E; player URL, fullscreen, fog undo, and Brush correction are complete while drag-to-size Circle and any reset polish remain proposed. |
...
| F-008E | Drag-To-Size Circle Fog Shape | Proposed | Proposed | [F-008E.md](./F-008E.md) | 2026-07-06 | Proposed follow-up for a true Circle shape that stretches during drag like Rectangle; current fixed-size circular tool is corrected as Brush in B-011. |
