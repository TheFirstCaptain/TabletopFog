...
| F-008 | Table Quality-of-Life Improvements | Proposed | Proposed | [F-008.md](./F-008.md) | 2026-07-04 | Split child features F-008A through F-008D; player URL, fullscreen, and fog undo are complete while expanded fog shapes and any reset polish remain proposed. |
...
| F-008D | Expanded Fog Shape Tools | Proposed | Proposed | [F-008D.md](./F-008D.md) | 2026-07-04 | Scaffolded to discuss circular fog tools, size choices, brush-like behavior, and other non-rectangle fog shapes before implementation. |
