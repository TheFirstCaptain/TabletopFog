...
| F-008 | Table Quality-of-Life Improvements | Proposed | Proposed | [F-008.md](./F-008.md) | 2026-07-05 | Split child features F-008A through F-008D; player URL, fullscreen, fog undo, and circle fog shapes are complete while any reset polish remains proposed. |
...
| F-008D | Expanded Fog Shape Tools | Complete | Done | [F-008D.md](./F-008D.md) | 2026-07-05 | Circle fog tools are complete with Hide/Reveal actions, Rectangle/Circle shape choice, percent diameter controls, ordered persistence, reviews, and full quality validation. |
