...
| F-005A | Campaign Landing Page Polish | Proposed | Proposed | [F-005A.md](./F-005A.md) | 2026-06-25 | Replace the utilitarian campaign list with fantasy-themed campaign cards. |
| F-005B | Encounter Card Gallery and Workspace Entry | Proposed | Proposed | [F-005B.md](./F-005B.md) | 2026-06-25 | Replace the map manager list with encounter cards and make showing a map to players explicit. |
| F-005C | Encounter Workspace Shell | Proposed | Proposed | [F-005C.md](./F-005C.md) | 2026-06-25 | Add the GM workspace shell for a selected/editing encounter before fog tools. |
