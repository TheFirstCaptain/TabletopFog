...
| F-008 | Table Quality-of-Life Improvements | Proposed | Proposed | [F-008.md](./F-008.md) | 2026-07-06 | Split child features F-008A through F-008E; player URL, fullscreen, fog undo, Brush correction, and drag-to-size Circle are complete while any reset polish remains proposed. |
