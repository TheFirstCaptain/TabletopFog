...
| F-007C | Persistence Validation and Recovery States | Active | Clarifying | [F-007C.md](./F-007C.md) | 2026-07-03 | Planning pass captured recommended malformed fog and missing asset recovery policy, fixture matrix, and implementation slices. |
