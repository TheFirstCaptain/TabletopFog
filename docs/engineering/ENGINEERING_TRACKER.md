...
| E-004 | Separate Server Transport Responsibilities | Proposed | P1 | [E-004.md](./E-004.md) | 2026-07-02 | Tier 0 planning pass recorded; later implementation should preserve route/projection/socket/startup contracts while extracting role projection, socket sync, route registration, and server composition. |
