...
| E-013 | Split Fog-Only Workspace Rendering | Done | P3 | [E-013.md](./E-013.md) | 2026-07-10 | Workspace-only render path now avoids gallery rebuilds for selected-encounter fog append, Clear Fog, Undo, and matching socket syncs; full quality passed. |
| E-014 | Parallelize Browser Workflow Tests | Done | P3 | [E-014.md](./E-014.md) | 2026-07-10 | Browser workflows now run fully parallel with 4 workers by default after three stable candidate runs, full local quality validation, and green CI matrix confirmation. |
| E-015 | Extract Server Mutation Orchestration | Done | P2 | [E-015.md](./E-015.md) | 2026-08-01 | Extracted campaign/session mutation service, reduced route orchestration, added focused service coverage, updated module baseline, and preserved existing behavior. |
| E-016 | Split GM Client Render Responsibilities | Done | P2 | [E-016.md](./E-016.md) | 2026-08-02 | Extracted focused GM render modules for campaign library, encounter gallery, handout library, and shared render helpers while preserving GM/player behavior. |
| E-017 | Add Module Cohesion Review Guidance | Proposed | P3 | [E-017.md](./E-017.md) | 2026-07-31 | Extend module maintenance guidance so broad responsibilities are tracked and scheduled, not only physical line-count growth. |
| E-018 | Harden GM Role Authorization | Deferred | P3 | [E-018.md](./E-018.md) | 2026-07-31 | Track future replacement of route/referer-based GM checks if TabletopFog moves beyond trusted same-LAN use, without adding V1 setup friction now. |
