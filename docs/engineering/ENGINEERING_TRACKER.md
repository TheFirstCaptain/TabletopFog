...
| E-015 | Extract Server Mutation Orchestration | Proposed | P2 | [E-015.md](./E-015.md) | 2026-07-31 | Route handlers should stay thin while campaign mutation, state-store update, and broadcast sequencing move behind a focused service boundary. |
