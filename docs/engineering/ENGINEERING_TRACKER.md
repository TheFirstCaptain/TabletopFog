...
| E-016 | Split GM Client Render Responsibilities | Proposed | P2 | [E-016.md](./E-016.md) | 2026-07-31 | Extract focused GM render modules for campaign library, encounter gallery, handout library, and workspace tools before more large UI work accumulates. |
