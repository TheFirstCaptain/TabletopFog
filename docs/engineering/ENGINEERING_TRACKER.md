...
| E-003 | Separate GM Client Responsibilities | Proposed | P2 | [E-003.md](./E-003.md) | 2026-06-20 | Separate API, state coordination, rendering, and event wiring while preserving the plain-browser approach. |
